...
import { Pencil, Trash, ArrowUp, Clock, Factory, PackageCheck, CheckCircle, ShoppingCart, PlusCircle } from 'lucide-react';
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-navigation">
        ...
        >
          <ShoppingCart className="button-icon" size={20} /> Vendas
        </Button>
        <Button
          variant="default"
          className="dash-button"
        ...
        >
          <PlusCircle className="button-icon" size={20} /> Novo Pedido
        </Button>
        {/* Outros botões de navegação serão adicionados aqui */}
      </div>
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-2 items-center">
                <Button
                  ...
                  onClick={() => navigate('/cadastro', { state: { pedido } })}
                >
                  <Pencil size={16} />
                </Button>
                <Button
